...
The Pico reads timestamps from the UART serial input on the format "MMSSUU",
interpreted as MM=minutes, SS=seconds and UU is 1/100 second. The numbers must include leading zeros.

Example: 010345 is displayed as 01:03.45 on the display
...
# serial communication through UART0, TX=0, RX=1
...
# setup second core to read serial data and update display, i.e. pixels_out
